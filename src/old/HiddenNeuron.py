import numpy as np
import old.ActivationFunctions_2 as ActivationFunctions_2
import math
...
class HiddenNeuron():
    ...
    def __init__(self, index:int, activation_fun:callable = ActivationFunctions_2.sigmoid, *args):
        '''
        Neuron constructor
    ...
    def backward(self):
        ...
        delta_error = self.partial_successors_weighted_errors * ActivationFunctions_2.derivative(self.f, self.net, *self.f_parameters)
